...
<div class="container" id="dPView">
	<form name="viewDegreePlan"  action="/dpa/submitToChair" class="form-horizontal" onsubmit="" method="POST">
	...
	<table class="table table-striped" id="r2DPTable">
		<tbody>
			<tr>
				<td colspan="4">Associate Chair for Graduate Studies: ${degreePlan.associateChairSignature}</td>
			</tr>
		</tbody>
	</table>
	<div class="col-sm-4">
		<input type="submit" value="Submit to Chair" class="btn btn-primary btn-block" id="acceptDP" />
	</div>
	</form>
	<div class="form-group">
		<div>
