...
<div class="container" id="dPView">
	...
	<table class="table table-striped" id="r2DPTable">
		<tbody>
			<tr>
				<td colspan="4">Department Chair: ${degreePlan.chairSignature}</td>
			</tr>
		</tbody>
	</table>
	<div class="col-sm-6">
		<input type="submit" value="Send the Approved Degree Plan to Student" class="btn btn-primary btn-block" id="acceptDP" />
	</div>
	</form>
</div>
